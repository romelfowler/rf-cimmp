...
<section id="process" class="wow fadeInUp animated color-code no-padding-top md-no-background-img xs-padding-50px-tb margin-100px-bottom parallax" data-color="11" style="background: url('wp-content/themes/cimmp-v2/assets/images/splash/1.png')  no-repeat -10% 108% / 40%;  ">
  ...
  <div class="row">
      <div class="col-md-7 col-sm-12 col-xs-12 center-col text-center margin-100px-top margin-100px-bottom xs-margin-40px-bottom">
          <div class="position-relative overflow-hidden width-100">
              <span class="text-outside-line-full alt-font font-weight-600 fs-40px padding-40px-tb"><?php echo $process_title; ?></span>
          </div>
      </div>
  </div>
